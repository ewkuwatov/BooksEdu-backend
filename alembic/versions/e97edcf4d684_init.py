...
Revision ID: e97edcf4d684
Revises: 
Create Date: 2025-10-22 15:59:55.646243
...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['university_id'], ['universities.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('name', 'kafedra_id', 'university_id', name='uq_subject_name_kafedra_university')
    )
